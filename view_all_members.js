...
const fetchAllMembers = async () => {
  const responseData = await sendHttpRequest('GET', 'https://project-website-php.000webhostapp.com/api/load_all_members.php');
...
const updateUI = (responseData) => {
  ...
  membersUI.forEach(memberUI => {
    document.getElementById('table-body').insertAdjacentElement('beforeend', memberUI);
  })
}
